      ...
      <div className="bg-white border shadow rounded-lg p-6">
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            className={`w-full border rounded px-3 py-2 pr-10 ${
              isEditingName ? "bg-white" : "bg-gray-100 text-gray-700"
            }`}
          />
          <div
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            className={`w-full border rounded px-3 py-2 pr-10 ${
              isEditingEmail ? "bg-white" : "bg-gray-100 text-gray-700"
            }`}
          />
          <div
            className="absolute right-3 top-9 cursor-pointer text-gray-500 hover:text-black"
        ...
        <div className="mb-4 relative">
          ...
          <input
            ...
            className={`w-full border rounded px-3 py-2 pr-10 ${
              isEditingPhone ? "bg-white" : "bg-gray-100 text-gray-700"
            }`}
          />
          <div
            className="absolute right-3 top-9 cursor-pointer text-gray-500 hover:text-black"
        ...
        {/* Save Button */}
        <Button1 className="mt-4 w-full">Save Changes</Button1>
      </div>
    </div>
  );
};
