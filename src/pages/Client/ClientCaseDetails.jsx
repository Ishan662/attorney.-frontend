...
const ClientCaseDetails = () => {
    ...
    return (
        // Use the authenticated currentUser for the layout
        <PageLayout user={currentUser}> 
            ...
            {/* Parties Involved - View Only */}
            <section className="bg-white rounded-lg p-8 mb-6 shadow-md">
                {/* --- REMOVED: "Add / Invite Client" button is gone --- */}
                <h2 className="text-xl font-semibold mb-6">Parties Involved</h2>
                <div className="flex flex-col md:flex-row">
                    <div className="flex-1 mb-6 md:mb-0">
                        <div className="font-semibold">Your Lawyer:</div>
                        {/* We should get the lawyer's name from the backend DTO */}
            ...
            <section className="bg-white rounded-lg p-8 mb-6 shadow-md">
                ...
                {/* --- REMOVED: The "Add New Hearing Date" button is gone --- */}
            </section>
            ...
            {/* --- REMOVED: All modals (AddClient, AddHearing, EditHearing) are gone --- */}
