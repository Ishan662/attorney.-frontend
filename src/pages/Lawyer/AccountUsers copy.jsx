...
const AccountUsers = () => {
    ...
    // New junior lawyer form state (simplified - removed salary and location)
    ...
    // Add new user (junior lawyer or client) - Backend integration
    const handleAddUser = async (e) => {
        ...
        try {
            if (activeTab === "junior-lawyers") {
                ...
                // Optionally reload the junior lawyers list here if you have a backend endpoint
                // await loadJuniorLawyers();
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-lg mx-4">
                        ...
                        <form onSubmit={handleAddUser}>
                            ...
                            {/* Only show location field for clients */}
                            {activeTab === "clients" && (
                                <div className="mb-4">
                                    <label className="block text-sm font-medium text-gray-700 mb-1">
                                        Location
